...
module RedmineMonacoEditor
  class ViewHook < Redmine::Hook::ViewListener
    ...
    I18N_KEYS = %w[
      mode_edit mode_edit_tip mode_split mode_split_tip mode_preview
...
unless ENV['REDMINE_MONACO_SKIP_ASSET_LINK'] == '1'
  ...
  Rails.logger.info '[redmine_monaco_editor] asset symlink setup skipped by REDMINE_MONACO_SKIP_ASSET_LINK=1'
end
